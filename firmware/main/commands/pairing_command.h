...
namespace home_energy_manager
{
    namespace controller
    {
        ...
        private:
            ...
            pairing_command()
                : m_remote_node_id(0), m_setup_pincode(0), m_discriminator(0), m_callbacks{nullptr, nullptr, nullptr}, m_icd_registration(true), m_icd_registration_strategy(chip::Controller::ICDRegistrationStrategy::kBeforeComplete)
            {
